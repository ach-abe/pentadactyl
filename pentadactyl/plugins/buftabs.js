...
highlight.loadCSS(
    ...
    "[highlight~=\"BufTabSelected\"] {background-repeat:no-repeat; background-size:contain, contain; background-position: 2px top; color:#ff0000; background-color:#fff; margin:0 !important; font-weight:normal; border-bottom-left-radius:2px; border-bottom-right-radius:2px;max-width:130px;}\n"+
